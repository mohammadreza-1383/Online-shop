...
//   return (
//     <div className="fixed top-[15px] right-[15px] bottom-[15px] w-[600px]  overflow-y-auto max-[526px]:w-[140px]  max-[769px]:w-[236px] max-[1025px]:w-[190px]
...
//     <img src={product.img} alt=""   className="cursor-pointer w-[320px] h-[320px] object-cover rounded-[10px] max-[526px]:w-[140px] max-[526px]:h-[140px] max-[769px]:w-[236px] max-[769px]:h-[236px] max-[1025px]:w-[190px] max-[1025px]:h-[190px]"/>
...
//     <div className='flex justify-center items-center rounded-[5px] w-[150px] border-[1px] border-[#d9d9d9] gap-[12px] mt-[20px]'>
// <button className=' py-[5px] px-[10px] flex justify-center items-center '>  -</button>
// <p className='border-x-[1px] border-[#d9d9d9] py-[5px] px-[10px] ' >01</p>
// <button className=' py-[5px] px-[10px] flex justify-center items-center'>+  </button>

//     </div>

// <div className='w-[260px] flex justify-between items-center gap-[10px] mt-[30px] mb-[150px] '>
  
//     {buttons.map((btn, index) => (
//         <button
//           key={index}
//           onClick={() => setActiveButton(index)}
//           className={`w-[42px] h-[42px] flex justify-center items-center rounded-md	border-[1px] border-[#FE8A00]
//             ${
//               activeButton === index
